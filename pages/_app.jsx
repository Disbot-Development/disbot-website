...
export default function App({ Component, pageProps }) {
    ...
    return (
        <ThemeProvider defaultTheme='blurple'>
            ...
            <div className='h-screen relative border-t-4 border-blurple-600'>
                <div
                    className='bg-gradient-to-b z-10 opacity-[25%] absolute top-0 w-full from-blurple-600 to-transparent'
                    style={{ height: '500px' }}
                />
                <Head>
                    <title>Disbot</title>
