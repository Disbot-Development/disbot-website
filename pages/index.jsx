            ...
            <div className='grid grid-cols-1 lg:grid-cols-12 gap-y-12 lg:gap-y-0 lg:gap-x-12 py-24 lg:my-40'>
                <div className='col-span-4'>
                    ...
                    <a
                        ...
                        className={
                            'mt-10 flex items-center px-4 justify-center gap-x-2 shadow-lg shadow-blurple-600/20 cursor-pointer rounded-xl py-4 font-medium bg-gradient-to-r from-blurple-700 to-blurple-500 hover:opacity-80 transition duration-200 text-white'
                        }
                    >
                ...
                <div className='col-span-8 grid grid-cols-1 lg:grid-cols-2 gap-6'>
                    <div>
                        <div className='text-white'>
                            <p className='text-xl font-semibold mt-5'>
                                <i
                                    className={`fa fa-cogs text-2xl text-blurple-500`}
                                />{' '}
                                Optimisé
                            </p>
                    ...
                    <div>
                        <div className='text-white'>
                            <p className='text-xl font-semibold mt-5'>
                                <i
                                    className={`fa fa-shield text-2xl text-blurple-500`}
                                />{' '}
                                Sécurité
                            </p>
                            <p className='text-gray-500 line-clamp-4'>
                    ...
                    <div>
                        <div className='text-white'>
                            <p className='text-xl font-semibold mt-5'>
                                <i
                                    className={`fa fa-tools text-2xl text-blurple-500`}
                                />{' '}
                                Modération
                            </p>
                            <p className='text-gray-500 line-clamp-4'>
                    ...
                    <div>
                        <div className='text-white'>
                            <p className='text-xl font-semibold mt-5'>
                                <i
                                    className={`fa fa-ticket text-2xl text-blurple-500`}
                                />{' '}
                                Support
                            </p>
                            <p className='text-gray-500 line-clamp-4'>
